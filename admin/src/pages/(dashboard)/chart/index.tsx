...
import {StatisticsTable} from "@/features/stats/statistics-table";
    ...
    <UsersProvider>
      ...
      <Main>
        <div className='mb-2 flex flex-wrap items-center justify-between space-y-2'>
          <div>
            <h2 className='text-2xl font-bold tracking-tight'>Daily Statistics</h2>
            <p className='text-muted-foreground'>
              Views daily statistics of level one and two.
            </p>
          </div>
          <UsersPrimaryButtons />
        </div>
