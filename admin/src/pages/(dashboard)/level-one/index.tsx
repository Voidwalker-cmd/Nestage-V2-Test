...
import {StakersDashboard} from "@/features/levelOne/stakers-dashboard";
    ...
    <UsersProvider>
      ...
      <Main>
        <div className='mb-2 flex flex-wrap items-center justify-between space-y-2'>
          <div>
            <h2 className='text-2xl font-bold tracking-tight'>Level One</h2>
            <p className='text-muted-foreground'>
              Manage all Level one payment here.
            </p>
          </div>
          <UsersPrimaryButtons />
        </div>
