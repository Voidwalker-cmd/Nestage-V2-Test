...
export default function Page() {
    ...
    return (
        <div className="relative lg:h-full bg-[#021009]">
            <div
            ...
            ></div>
            <GoBackBtn />
            <div className="flex justify-center items-center lg:items-center w-full h-full border-none lg:border rounded-lg py-3 lg:py-10">
